...
load("~/Data/JAHEAD/Process_Files/data_after_71a_72a.rda")
fit_model <- stan(file="src/71b_hierarchical_model_adl_2levels.stan", data=list_stan_2levels, cores = 4, seed=1234,
