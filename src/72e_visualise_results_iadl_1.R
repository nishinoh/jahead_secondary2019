...
load("~/Data/JAHEAD/Process_Files/stan_result_varying_intercept_iadl1.rda")
...
term_full <- c("子の性別(女性=1)", "子の年齢", "子の仕事(有職=1)", "居住場所の距離", "親の性別", "親のIADL困難度", "親の世帯人数", "ホームヘルプ利用回数")
...
quartz(file="~/downloads/fig_result_iadl.pdf", type="pdf",  width=8,height=4.5)
p
dev.off()